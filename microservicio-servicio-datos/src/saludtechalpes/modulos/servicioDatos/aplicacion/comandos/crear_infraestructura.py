...
from saludtechalpes.modulos.servicioDatos.dominio.eventos import InfraestructuraNoCreada
...
class CrearInfraestrcturaHandler(CrearServicioDatosBaseHandler):
    ...
    def handle(self, comando: CrearInfraestrctura):
        try:
            ...
            eventoFallido = InfraestructuraNoCreada(id_suscripcion=str(comando.suscripcion.suscripcion))
