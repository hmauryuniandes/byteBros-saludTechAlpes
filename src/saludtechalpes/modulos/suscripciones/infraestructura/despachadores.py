...
from saludtechalpes.modulos.suscripciones.infraestructura.schema.v1.eventos import EventoSuscripcionCreada, SuscripcionCreadaPayload
...
class Despachador:
    def _publicar_mensaje(self, mensaje, topico, schema):
        ...
        publicador = cliente.create_producer(topico, schema=AvroSchema(EventoSuscripcionCreada))
